//
//  SectionnedBarChartViewController.m
//  OLBarChartDemo
//
...
@implementation SectionnedBarChartViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
  ...
  if (self) {
    ...
    UITabBarItem* theItem = [[UITabBarItem alloc] initWithTitle:@"Sectionned" image:anImage tag:0];
...
- (void)viewDidLoad
{
  ...
  [barChartScrollView setRoundedCornerForBars:YES];
